...
const projects: Project[] = [
  { _id: "1", title: "Vertex Dashboard", slug: { current: "vertex-dashboard" }, category: "UI/UX", overview: "A high-performance analytics dashboard with real-time data visualization and collaborative workspace features.", thumbnail: null, techStack: [], teamMembers: [{ name: "Altaf Gill", slug: { current: "altaf-gill" }, photo: null }, { name: "Maya Patel", slug: { current: "maya-patel" }, photo: null }, { name: "Elena Voss", slug: { current: "elena-voss" }, photo: null }] },
  { _id: "2", title: "Nova Brand Identity", slug: { current: "nova-brand-identity" }, category: "Branding", overview: "Complete brand overhaul for a fintech startup including visual identity, design system, and launch collateral.", thumbnail: null, techStack: [], teamMembers: [{ name: "Altaf Gill", slug: { current: "altaf-gill" }, photo: null }, { name: "Rehman Ul Haq", slug: { current: "rehman-ul-haq" }, photo: null }] },
  { _id: "3", title: "Flow State CRM", slug: { current: "flow-state-crm" }, category: "Web App", overview: "Intelligent CRM platform designed for creative agencies to manage clients, projects, and pipeline.", thumbnail: null, techStack: [], teamMembers: [{ name: "Maya Patel", slug: { current: "maya-patel" }, photo: null }, { name: "Rehman Ul Haq", slug: { current: "rehman-ul-haq" }, photo: null }, { name: "Elena Voss", slug: { current: "elena-voss" }, photo: null }] },
];
